...
func (t *Transactor) Submit(ctx context.Context, envelope string, waitIngest bool) (*resources.TransactionResponse, error) {
	body := resources.SubmitTransactionBody{
		Tx:            envelope,
		WaitForIngest: &waitIngest,
	}

	var success resources.TransactionResponse
